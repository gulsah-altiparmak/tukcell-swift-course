...
class DetailWebController: UIViewController ,UIWebViewDelegate, WKUIDelegate, WKNavigationDelegate{
    ...
    override func viewDidLoad() {
        ...
        //WK yönlendirirci delegate otomatik yükler
        /* url for webview
        let url = "."
    ...
    func webView(_ webView: WKWebView, didCommit navigation: WKNavigation!) {
        print("web View Did Commit")
    }
    func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
        print("web View Did Finish")
        //web view sağlıklı yüklendi
    }
